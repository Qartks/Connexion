...
!function (a, b, c, d) {
    ...
    (function () {
        ...
        b.module("uiGmapgoogle-maps.extensions").service("uiGmapLodash", function () {
            ...
            return g = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\n\\]|\\.)*?)\2)\]/g, f = /\\(\\)?/g, d = function (a) {
            ...
            }, [{missingName: "contains", swapName: "includes", isProto: !0}, {
                ...
                swapName: "object"
            }, {missingName: "all", swapName: "every"}, {missingName: "every", swapName: "all"}, {
                missingName: "any",
                swapName: "some"
            }, {missingName: "some", swapName: "any"}, {missingName: "first", swapName: "head"}, {
                missingName: "head",
                swapName: "first"
            }].forEach(function (a) {
                return d(a)
        ...
        b.module("uiGmapgoogle-maps.directives.api.utils").service("uiGmap_sync", [function () {
            ...
            return A = d.promiseTypes, t = d.isInProgress, z = d.promiseStatus, i = d.ExposedPromise, k = d.SniffedPromise, u = function (a, b) {
            ...
            }, n = 80, r = {value: null}, B = function (a, b, c) {
                var d, e;
                try {
                    return a.apply(b, c)
                } catch (e) {
                ...
                var g, h, i;
                if (b.isArray(a)) g = a; else if (d) g = d; else {
                    g = [];
                ...
                setEvents: function (a, e, f, g) {
                    ...
                    if (h = d(e, f), null != h)return c.compact(c.map(h.events, function (d, i) {
                        ...
                        if (g && (j = c(g).includes(i)), h.events.hasOwnProperty(i) && b.isFunction(h.events[i]) && !j)return google.maps.event.addListener(a, i, function () {
                            return e.$evalAsync || (e.$evalAsync = function () {
                            }), e.$evalAsync(d.apply(e, [a, i, f, arguments]))
                        })
                    }))
                }, removeEvents: function (a) {
                    var b, c;
                    if (a)for (b in a)c = a[b], c && a.hasOwnProperty(b) && google.maps.event.removeListener(c)
                }
            }
        }])
    }.call(this), function () {
        ...
        b.module("uiGmapgoogle-maps.directives.api.utils").service("uiGmapGmapUtil", ["uiGmapLogger", "$compile", function (a, d) {
            ...
            return f = function (a, b, c) {
                ...
                setCoordsFromEvent: function (a, c) {
                ...
                }, isFalse: e, isFalsy: function (a) {
                    return f(a, !1, [void 0, null]) || e(a)
                }, getCoords: g, validateCoords: j, equalCoords: function (a, b) {
                    ...
                    var d, e, f, g, h;
                    if (e = 0, g = new google.maps.MVCArray, b.isUndefined(a.type))for (; e < a.length;)b.isDefined(a[e].latitude) && b.isDefined(a[e].longitude) ? f = new google.maps.LatLng(a[e].latitude, a[e].longitude) : "function" == typeof a[e].lat && "function" == typeof a[e].lng && (f = a[e]), g.push(f), e++; else for ("Polygon" === a.type ? d = a.coordinates[0] : "MultiPolygon" === a.type ? (h = {
                        max: 0,
                        index: 0
        ...
        b.module("uiGmapgoogle-maps.directives.api.utils").service("uiGmapPromise", ["$q", "$timeout", "uiGmapLogger", function (a, b, d) {
            ...
            return m = {create: "create", update: "update", delete: "delete", init: "init"}, l = {
                IN_PROGRESS: 0,
                RESOLVED: 1,
                REJECTED: 2
            }, o = function () {
        ...
        b.module("uiGmapgoogle-maps.directives.api.managers").factory("uiGmapSpiderfierMarkerManager", ["uiGmapLogger", "uiGmapFitHelper", "uiGmapPropMap", "uiGmapMarkerSpiderfier", function (d, e, f, g) {
            ...
            return h = function () {
                function h(b, c, e, i, j) {
                    null == c && (c = {}), this.opt_options = null != e ? e : {}, this.opt_events = i, this.scope = j, this.checkSync = a(this.checkSync, this), this.isSpiderfied = a(this.isSpiderfied, this), this.getGMarkers = a(this.getGMarkers, this), this.fit = a(this.fit, this), this.destroy = a(this.destroy, this), this.attachEvents = a(this.attachEvents, this), this.clear = a(this.clear, this), this.draw = a(this.draw, this), this.removeMany = a(this.removeMany, this), this.remove = a(this.remove, this), this.addMany = a(this.addMany, this), this.update = a(this.update, this), this.add = a(this.add, this), this.type = h.type, this.markerSpiderfier = new g(b, this.opt_options), this.propMapGMarkers = new f, this.attachEvents(this.opt_events, "opt_events"), this.noDrawOnSingleAddRemoves = !0, d.info(this)
                }
                ...
                return h.type = "SpiderfierMarkerManager", h.prototype.checkKey = function (a) {
                    ...
                    var e, f;
                    if (b.isDefined(a) && null != a && b.isObject(a))for (f in a)e = a[f], a.hasOwnProperty(f) && b.isFunction(a[f]) && (d.info(c + ": Clearing event: " + f + " to markerSpiderfier"), this.markerSpiderfier.clearListeners(f))
        ...
        b.module("uiGmapgoogle-maps").service("uiGmapObjectIterators", function () {
            ...
            return a = ["length", "forEach", "map"], b = [], d = function (b) {
                ...
                slapMap: e, slapForEach: d, slapAll: function (a) {
        ...
        b.module("uiGmapgoogle-maps.directives.api.options").service("uiGmapMarkerOptions", ["uiGmapLogger", "uiGmapGmapUtil", function (a, d) {
            return c.extend(d, {
                createOptions: function (a, c, e, f) {
                    ...
                    }), null == e.icon && null == c || (g = b.extend(g, {icon: null != e.icon ? e.icon : c})), null != f && (g.map = f), g
                }, isLabel: function (a) {
                    ...
                    function j(d) {
                        ...
                        this.scope = d.scope, this.attrs = d.attrs, this.gMap = d.gMap, this.defaults = d.defaults, this.model = d.model, h = d.gObjectChangeCb, this.isScopeModel = null != (j = d.isScopeModel) && j, this.clean = a(this.clean, this), this.isScopeModel && (this.clonedModel = c.clone(this.model, !0)), this.isDragging = !1, this.internalEvents = {
                            ...
                            return function () {
                                ...
                                }), b.isDefined(a.scope.events) && b.isObject(a.scope.events) && (a.listeners = a.model ? i.setEvents(a.gObject, a.scope, a.model) : i.setEvents(a.gObject, a.scope, a.scope)), a.internalListeners = a.model ? i.setEvents(a.gObject, {events: a.internalEvents}, a.model) : i.setEvents(a.gObject, {events: a.internalEvents}, a.scope)) : void 0
                            }
            ...
            return o = function (f) {
                ...
                return e(o, f), o.include(g), o.include(i), o.include(k), p = function (a) {
                    ...
                    switch (null == d && (d = void 0), null == e && (e = !1), null == f && (f = !0), null == b ? b = this.model : this.model = b, this.gObject || (this.setOptions(this.scope, f), g = !0), a) {
                        ...
                        case"icon":
                            return this.maybeSetScopeValue({gSetter: this.setIcon, doDraw: f});
                        case"coords":
                            return this.maybeSetScopeValue({gSetter: this.setCoords, doDraw: f});
                        case"options":
                    ...
                    if (null == b && (b = !0), !this.isNotValid(a, !1)) {
                        if (this.renderGMarker(b, function (b) {
                                return function () {
                                    var d, e, f;
                                    if (e = b.getProp("coords", a, b.model), f = b.getProp("icon", a, b.model), d = b.getProp("options", a, b.model), b.opts = b.createOptions(e, f, d), b.isLabel(b.gObject) !== b.isLabel(b.opts) && null != b.gObject && (b.gManager.remove(b.gObject), b.gObject = void 0), null != b.gObject && b.gObject.setOptions(b.setLabelOptions(b.opts)), b.gObject || (b.isLabel(b.opts) ? b.gObject = new MarkerWithLabel(b.setLabelOptions(b.opts)) : b.opts.content ? (b.gObject = new RichMarker(b.opts), b.gObject.getIcon = b.gObject.getContent, b.gObject.setIcon = b.gObject.setContent) : b.gObject = new google.maps.Marker(b.opts), c.extend(b.gObject, {model: b.model})), b.externalListeners && b.removeEvents(b.externalListeners), b.internalListeners && b.removeEvents(b.internalListeners), b.externalListeners = b.setEvents(b.gObject, b.scope, b.model, ["dragend"]), b.internalListeners = b.setEvents(b.gObject, {
                ...
                return e(n, f), n.include(g), n.include(m), n.prototype.doShow = function (a) {
                    ...
                    return a = null != this.markerScope ? this.markerScope : this.scope, a.$watch("coords", function (a) {
                        return function (b, c) {
                            var d;
                            if (b !== c) {
                                if (null == b) a.hideWindow(); else if (!a.validateCoords(b))return void h.error("WindowChildMarker cannot render marker as scope.coords as no position on marker: " + JSON.stringify(a.model));
                    ...
                    }(this), this.scope.templateUrl ? j.get(this.scope.templateUrl, {cache: k}).then(function (a) {
                        return function (e) {
                            var f;
                    ...
                    return this.isScopeModel && (this.clonedModel = c.clone(a, !0)),
                        c.extend(this.model, this.clonedModel || a)
                }, n
            }(f)
        }])
    }.call(this), function () {
        ...
        b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapMapTypeParentModel", ["uiGmapBaseObject", "uiGmapLogger", function (e, f) {
            ...
            return g = function (e) {
                ...
                return d(g, e), g.prototype.createMapType = function () {
                    var a, c, d;
                    if (d = this.childModel ? this.attrs.options ? this.childModel[this.attrs.options] : this.childModel : this.scope.options, null != d.getTile) this.mapType = d; else {
        ...
        b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapMarkersParentModel", ["uiGmapIMarkerParentModel", "uiGmapModelsWatcher", "uiGmapPropMap", "uiGmapMarkerChildModel", "uiGmap_async", "uiGmapClustererMarkerManager", "uiGmapMarkerManager", "$timeout", "uiGmapIMarker", "uiGmapPromise", "uiGmapGmapUtil", "uiGmapLogger", "uiGmapSpiderfierMarkerManager", function (e, f, g, h, i, j, k, l, m, n, o, p, q) {
            ...
            return s = function (a, b) {
                ...
                return d(l, e), l.include(o), l.include(f), l.prototype.onWatch = function (a, b, c, d) {
                    ...
                    }(this)) : [], {cluster: a, mapped: d, group: a})
                    ...
                    return i.then(function (c) {
                        return function (i) {
                            ...
                            return j = b.isUndefined(a.template), m = b.isDefined(a.index && !isNaN(parseInt(a.index))) ? parseInt(a.index) : void 0, n = b.isDefined(a.position) ? a.position.toUpperCase().replace(/-/g, "_") : "TOP_CENTER", i.ControlPosition[n] ? d.mapPromise(a, k).then(function (d) {
                                ...
                                }) : e.get(a.template, {cache: f}).success(function (c) {
                                    var d, e;
                                    return e = a.$new(), k.append(c), b.isDefined(a.controller) && (d = h(a.controller, {$scope: e}), k.children().data("$ngControllerController", d)), i = g(k.children())(e)
                                }).error(function (a) {
                ...
                return d(i, f), i.include(h), i.prototype.restrict = "EMA", i.prototype.transclude = !0, i.prototype.replace = !1, i.prototype.template = '<div class="angular-google-map"><div class="angular-google-map-container">\n</div><div ng-transclude style="display: none"></div></div>', i.prototype.scope = {
                    ...
                    return h = [], a.$on("$destroy", function () {
                        ...
                        return function (j) {
                            ...
                            if (s = {mapTypeId: j.MapTypeId.ROADMAP}, C = k.spawn(), A = function () {
                                    return C.deferred.resolve({instance: C.instance, map: m})
                            ...
                            if (b.isDefined(a.center) || (a.center = new google.maps.LatLngBounds(i.getCoords(a.bounds.southwest), i.getCoords(a.bounds.northeast)).getCenter()), b.isDefined(a.zoom) || (a.zoom = 10), t = b.element(d), t.addClass("angular-google-map"), y = {options: {}}, f.options && (y.options = a.options), f.styles && (y.styles = a.styles), f.type && (D = f.type.toUpperCase(), google.maps.MapTypeId.hasOwnProperty(D) ? y.mapTypeId = google.maps.MapTypeId[f.type.toUpperCase()] : g.error("angular-google-maps: invalid map type '" + f.type + "'")), w = b.extend({}, s, y, {
                                    ...
                                    if (null == b && (b = m.center), null == d && (d = a), !c.includes(o, "center") && (d.center.latitude !== b.lat() && (d.center.latitude = b.lat()), d.center.longitude !== b.lng()))return d.center.longitude = b.lng()
                                }, B = !1, x("idle", function () {
                                    var b, d, e;
            ...
            return f = function (d) {
                ...
                return c(f, d), f.prototype.link = function (a, c, d, f) {
                    ...
                    return g = [], h = b.mapPromise(a, f), null != a.control && (a.control.getInstance = this, a.control.polygons = g, a.control.promise = h), h.then(function (b) {
                        return function (c) {
                            return g.push(new e({scope: a, attrs: d, gMap: c, defaults: b.DEFAULTS}))
                        }
                    }(this))
                }, f
            }(b)
            ...
            init: c.once(function () {
                +function () {
                    ...
                    b.prototype.onAdd = function () {
                        ...
                        var d = !c, e = this.removeMarker_(a, d);
                        ...
                        if (this.ready_) {
                            ...
                            if (g < this.markers_.length) this.timerRefStatic = setTimeout(function () {
                                e.createClusters_(g)
                            }, 0); else for (delete this.timerRefStatic, google.maps.event.trigger(this, "clusteringend", this), b = 0; b < this.clusters_.length; b++)this.clusters_[b].updateIcon_()
                        }
                        ...
                        return document.defaultView && document.defaultView.getComputedStyle ? (a = c.ownerDocument.defaultView.getComputedStyle(c, ""), a && (b.top = parseInt(a.borderTopWidth, 10) || 0, b.bottom = parseInt(a.borderBottomWidth, 10) || 0,
        ...
        (function () {
            ...
            b = function () {
                ...
                return a.prototype.addNode = function (a) {
                    if (!this._nodes[a])return this.nodeSize++, this._nodes[a] = {_outEdges: {}, _inEdges: {}}
                    ...
                    var d, e, f;
                    if (null == c && (c = 1), !this.getEdge(a, b) && (e = this._nodes[a], f = this._nodes[b], e && f))return d = {weight: c}, e._outEdges[b] = d, f._inEdges[a] = d, this.edgeSize++, d
                    ...
                    for (e = this.getEdge(a, a), b = f = 0, g = c.length; 0 <= g ? f < g : f > g; b = 0 <= g ? ++f : --f)if (c[b] === e) {
        ...
        (function () {
            ...
            b = function () {
                function a(a) {
                    ...
                    if (this._data.length > 1)for (b = e = 2, g = this._data.length; 2 <= g ? e < g : e > g; b = 2 <= g ? ++e : --e)this._upHeap(b);
            ...
            b = function () {
                ...
                return a.prototype.at = function (a) {
                    ...
                    if (-this.size <= a && a < this.size) {
                        if (a = this._adjust(a), 2 * a < this.size)for (b = this.head, c = d = 1; d <= a; c = d += 1)b = b.next; else for (b = this.tail, c = e = 1, f = this.size - a - 1; e <= f; c = e += 1)b = b.prev;
                        return b
                    }
                }, a.prototype.add = function (a, b) {
                    var c, d, e, f, g;
                    if (null == b && (b = this.size), -this.size <= b && b <= this.size)return d = {value: a}, b = this._adjust(b), 0 === this.size ? this.head = d : 0 === b ? (e = [d, this.head, d], this.head.prev = e[0], d.next = e[1], this.head = e[2]) : (c = this.at(b - 1), f = [c.next, d, d, c], d.next = f[0], null != (g = c.next) ? g.prev = f[1] : void 0, c.next = f[2], d.prev = f[3]), b === this.size && (this.tail = d), this.size++, a
        ...
        (function () {
            ...
            c = "_mapId_", b = function () {
                ...
                var b, c, e, f, g;
                for (b = ["Boolean", "Number", "String", "Undefined", "Null", "RegExp", "Function"], e = d(a), f = 0, g = b.length; f < g; f++)if (c = b[f], e === c)return !1;
                return !0
            }, d = function (a) {
        ...
        (function () {
            ...
            b = c(6), e = "end", d = function () {
                ...
                return a.prototype.add = function (a) {
                    ...
                    if (null == a)return [];
                    for (null != a || (a = ""), k = [], d = this._root, l = 0, m = a.length; l < m; l++)if (f = a[l], d = d[f], null == d)return [];
                    ...
                    if (null != a) {
                        ...
                        if (b[e]) {
                            ...
                            for (c = i = k = g.length - 1; (k <= 1 ? i <= 1 : i >= 1) && !f(g[c][1], 1); c = k <= 1 ? ++i : --i)delete g[c - 1][1][g[c][0]];
            ...
            this.OverlappingMarkerSpiderfier = function () {
                ...
                return f = void 0, e = void 0, k = void 0, n = 2 * Math.PI, l.keepSpiderfied = !1, l.markersWontHide = !1, l.markersWontMove = !1, l.nearbyDistance = 20, l.circleSpiralSwitchover = 9, l.circleFootSeparation = 23, l.circleStartAngle = n / 12, l.spiralFootSeparation = 26, l.spiralLengthStart = 11, l.spiralLengthFactor = 4, l.spiderfiedZIndex = 1e3, l.usualLegZIndex = 10, l.highlightedLegZIndex = 20, l.event = "click", l.minZoomLevel = !1, l.legWeight = 1.5, l.legColors = {
                    ...
                    for (o = this.nearbyDistance, p = o * o, m = function () {
                        ...
                        return f
                    }.call(this), r = this.markers, b = d = 0, e = r.length; d < e; b = ++d)if (i = r[b], null != i.map && i.getVisible() && (j = m[b], !j.willSpiderfy))for (s = this.markers, c = n = 0, f = s.length; n < f; c = ++n)if (k = s[c], c !== b && null != k.map && k.getVisible() && (l = m[c], (!(c < b) || l.willSpiderfy) && this.ptDistanceSq(j.pt, l.pt) < p)) {
                    ...
                    for (c = d = 0, e = a.length; d < e; c = ++d)if (f = a[c], f === b)return c;
                    return -1
                }, d
            }()
